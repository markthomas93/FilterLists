...
namespace FilterLists.Api.Controllers.V3
{
    ...
    public class OrdersController : ODataController
    {
        ...
        {
            return SingleResult.Create(new[] {new Order {Id = key, Customer = "John Doe"}}.AsQueryable());
        }
        ...
        [ProducesResponseType(Status204NoContent)]
        [ProducesResponseType(Status404NotFound)]
        public IActionResult Delete(int key, bool suspendOnly)
        {
            return NoContent();
        }
        ...
        {
            return SingleResult.Create(new[] {new Order {Id = 42, Customer = "Bill Mei"}}.AsQueryable());
        }
